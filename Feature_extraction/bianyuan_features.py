...
def main(path):
    # if not os.path.exists("../data/bianyuan_features"):
    #     os.mkdir("../data/bianyuan_features")
    # if not os.path.exists("../data/bianyuan_features/difffeature_matrix"):
    #     os.mkdir("../data/bianyuan_features/difffeature_matrix")
    # if not os.path.exists("../data/bianyuan_features/huffman_feature"):
    #     os.mkdir("../data/bianyuan_features/huffman_feature")
    ...
    np.save("../data/bianyuan_features/difffeature_matrix/" + path.split('/')[-1].split('.')[0] + ".npy", local_feature)
    ...
    np.save("../data/bianyuan_features/huffman_feature/" + path.split('/')[-1].split('.')[
        0] + ".npy", global_Huffman_feature)

    print(path + ' ' + 'process success!')

if __name__ == '__main__':
    bit_path = '../data/bianyuan_JPEGBitStream/*.npy'
