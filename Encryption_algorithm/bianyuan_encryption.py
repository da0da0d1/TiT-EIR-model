...
from bianyuan_cipherimageRgbGenerate import Gen_cipher_images
...
imageFiles = loadImageFiles('../data/bianyuan_img/*.jpg')
bit_path = '../data/bianyuan_JPEGBitStream/'
keys_path = '../data/bianyuan_keys/'
